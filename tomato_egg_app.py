...
# 碳足跡數據（每公里）
TRANSPORT_CO2 = {
    "walking": 0.0,       # 走路 (不消耗燃料)
    "motorcycle": 0.078,  # 機車 (kgCO2e per km)
    "car": 0.144,         # 汽車 (kgCO2e per km)
    "truck": 0.278,       # 貨車 (kgCO2e per km)
}
...
# 交通碳足跡計算
transport_mode = st.selectbox("選擇交通方式", ["walking", "motorcycle", "car", "truck"])
